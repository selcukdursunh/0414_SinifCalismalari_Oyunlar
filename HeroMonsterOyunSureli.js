...
var sure = 20;
var level = 1;
var zamanlayici = setInterval(function (surem) {
        surem--;     
        if (sure == 0) {
            if (yakalaMons > 9) {
...
var render = function () {
    ...
    firca.font = "arial";
    firca.fillText("Skor: " + yakalaMons, 20, 10);
    firca.fillText("Süre: " + sure, tuval.width - 60, 10);
    firca.fillText("Level: " + level, tuval.width/2-10, 10);
}
